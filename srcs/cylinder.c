...
/*   Updated: 2020/01/31 11:36:50 by hezzahir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cylindre_rot_tran(t_rtv1 *r, t_cylindre *cylindre, char *s1, char *s2)
{
...
void	set_cylindre(char **words, t_rtv1 *r)
{
	...
	cylindre_rot_tran(r, cylindre, words[6], words[7]);
